...
import agileDataHubHomepage from '/assets/article-images/agile-robots/agile-data-hub-homepage.png'
import agileDataHubReceipt from '/assets/article-images/agile-robots/agile-data-hub-receipt.png'
import agileIssuesIdentified from '/assets/article-images/agile-robots/agile-issues-identified.png'
import agileRobotCups from '/assets/article-images/agile-robots/agile-robots-press-image.jpg'
import agileIsarWalk from '/assets/article-images/agile-robots/isar_walk_bridge.jpg'
...
const sections = ref<Section[]>([
  {
    title: undefined,
    content: `After several years in two different career paths in Berlin, I moved to Munich for a new opportunity with a larger robotics company, Agile Robots. Split into multiple sub-teams, I joined the IDE team to work on a development environment that enables operators to define and adapt custom robot actions. The stack centered around Vue with TypeScript on the frontend, backed by GraphQL and Python/Django services.
...
`,
  },
  {
    ...
    content: `One of my earliest initiatives was working on the Agile Data Hub, a marketplace for robot task datasets. I collaborated in a lean team of one other developer and one designer to deliver a proof-of-concept under tight time constraints. We built the MVP using Nuxt, Prisma with SQLite, BetterAuth, and Stripe, focusing on validating the commercial and technical feasibility of selling curated robot action datasets. This was my first experience with a meta-framework like Nuxt, and I appreciated how it streamlined development while still allowing for flexibility in architecture.

<img 
  src="${agileDataHubHomepage}" 
...
<img 
  src="${agileDataHubReceipt}" 
  alt="Agile Data Hub receipt after purchase" 
  class="rounded-lg shadow-lg my-8 max-w-xs mx-auto" 
/>`,
  },
  {
    title: 'Design Engineering & Beyond',
    content: `Over time, I positioned myself closer to a design engineer role. I worked directly with our designers to close the gap between conceptual interface design and implementation realities. Rather than treating Figma files or feature PRs as static handoffs, I used them to get a solid big-picture view of the application.
